...
share_menu = InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text=f'🔗 Поделиться', url="https://t.me/share/url?url=По этой ссылке можно отправить мне анонимное сообщение👉t.me/Anonim_Messssage_Bot?start={hash}")]])
